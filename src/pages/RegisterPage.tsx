        ...
        <div className="relative z-10 space-y-8">
          <div>
            <h2 className="text-4xl font-bold text-white leading-tight mb-4">
              {t("joinTeam", lang)}
              <br />
              <span className="text-primary-200">{t("inSeconds", lang)}</span>
            </h2>
          ...
          <div className="space-y-4">
            <div className="flex items-center gap-4">
              ...
              <div>
                <p className="text-white font-medium">{t("quickSetup", lang)}</p>
                <p className="text-sm text-white/50">{t("quickDesc", lang)}</p>
              </div>
            </div>
            <div className="flex items-center gap-4">
              <div className="w-10 h-10 rounded-xl bg-white/10 backdrop-blur-sm flex items-center justify-center shrink-0">
              ...
              <div>
                <p className="text-white font-medium">{t("secureData", lang)}</p>
                <p className="text-sm text-white/50">{t("secureDesc", lang)}</p>
              </div>
            </div>
            <div className="flex items-center gap-4">
              <div className="w-10 h-10 rounded-xl bg-white/10 backdrop-blur-sm flex items-center justify-center shrink-0">
              ...
              <div>
                <p className="text-white font-medium">{t("effectiveCollab", lang)}</p>
                <p className="text-sm text-white/50">{t("effectiveDesc", lang)}</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="w-full max-w-md">
          ...
          {error && (
            <div className="mb-5 flex items-start gap-3 px-4 py-3 bg-red-500/10 border border-red-500/30 rounded-xl">
              ...
              <div>
                <p className="text-sm font-medium text-red-300">{t("registerFailed", lang)}</p>
